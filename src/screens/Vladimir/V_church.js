...
export default class V_church extends React.Component{
  ...
  render(){
    ...
    return(
      <LinearGradient 
            ...
            >
          <ScrollView>
        {Object.keys(data.vladimir.church).map((item, index) => {
        return(
          
          <React.Fragment key={data.vladimir.church[item].id}>
              <Modal
                animationType="slide"
                transparent={true}
              ...
              >
                  <View style={styles.modalView}>
                    <Text style={styles.modalText}>{data.vladimir.church[item].description}</Text>
                    <Pressable
              ...
              > 
                <View>
                  <Text style={{alignItems: "center", marginBottom: 10, fontSize: 17}}>{data.vladimir.church[item].name}</Text>
                </View>
                <Image  source={{ uri: data.vladimir.church[item].img }} style={{ width: 250, height: 250,  borderRadius: 10, justifyContent: "center"}} />
              </Pressable>
