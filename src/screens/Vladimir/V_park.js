  ...
  render(){
    ...
    return(
      <LinearGradient 
            ...
            >
          <ScrollView>
        {Object.keys(data.vladimir.park).map((item, index) => {
        return(
          
          <React.Fragment key={data.vladimir.park[item].id}>
              <Modal
                animationType="slide"
                transparent={true}
              ...
              >
                  <View style={styles.modalView}>
                    <Text style={styles.modalText}>{data.vladimir.park[item].description}</Text>
                    <Pressable
              ...
              > 
                <View>
                  <Text style={{alignItems: "center", marginBottom: 10, fontSize: 17}}>{data.vladimir.park[item].name}</Text>
                </View>
                <Image  source={{ uri: data.vladimir.park[item].img }} style={{ width: 250, height: 250,  borderRadius: 10, justifyContent: "center"}} />
              </Pressable>
