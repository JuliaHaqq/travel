    ...
    return(
      <LinearGradient 
        ...
        return(
          ...
          <React.Fragment key={data.astrakhan.cinema[item].id}>
              <Modal
                animationType="slide"
                transparent={true}
              ...
              > 
                <View>
                  <Text style={{alignItems: "center", marginBottom: 10, fontSize: 17, marginLeft: 5, marginRight: 5}}>{data.astrakhan.cinema[item].name}</Text>
                </View>
