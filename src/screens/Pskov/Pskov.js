...
export default class Pskov extends React.Component{
  render(){
    ...
    return(
        ...
        > 
          ...
          <View style={styles.img_gg}>
            ...
            <View style={styles.img_gg}>
              <TouchableOpacity onPress={()=>navigate('P_church')} >
            ...
            <View style={styles.img_gg}>
              <TouchableOpacity onPress={()=>navigate('P_park')} >
            ...
            <View style={styles.img_gg}>
              <TouchableOpacity onPress={()=>navigate('P_cinema')} >
