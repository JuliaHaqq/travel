...
export default class U_cinema extends React.Component {
  ...
  render(){
    ...
    return(
      <LinearGradient 
            ...
            >
          <ScrollView>
        {Object.keys(data.ufa.cinema).map((item, index) => {
        return(
          
          <React.Fragment key={data.ufa.cinema[item].id}>
              <Modal
                animationType="slide"
                transparent={true}
              ...
              >
                  <View style={styles.modalView}>
                    <Text style={styles.modalText}>{data.ufa.cinema[item].description}</Text>
                    <Pressable
              ...
              > 
                <View>
                  <Text style={{alignItems: "center", marginBottom: 10, fontSize: 17, marginLeft: 5, marginRight: 5}}>{data.ufa.cinema[item].name}</Text>
                </View>
                <Image  source={{ uri: data.ufa.cinema[item].img }} style={{ width: 250, height: 250,  borderRadius: 10, justifyContent: "center"}} />
              </Pressable>
