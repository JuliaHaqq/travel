...
export default class Ufa extends React.Component{
  render(){
    ...
    return(
        ...
        > 
          ...
          <View style={styles.img_gg}>
            ...
            <View style={styles.img_gg}>
              <TouchableOpacity onPress={()=>navigate('U_church')} >
            ...
            <View style={styles.img_gg}>
              <TouchableOpacity onPress={()=>navigate('U_park')} >
            ...
            <View style={styles.img_gg}>
              <TouchableOpacity onPress={()=>navigate('U_cinema')} >
